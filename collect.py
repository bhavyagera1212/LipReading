...
from my_lips_reading_1.model.constants import TOTAL_FRAMES, VALID_WORD_THRESHOLD, NOT_TALKING_THRESHOLD, PAST_BUFFER_SIZE, LIP_WIDTH, LIP_HEIGHT
...
data_count = 1
words =["apple", "cherry", "order", "fig", "hello","water","hi","okay"]
options = ", ".join(words)
